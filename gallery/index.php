...
if (in_array($act, $array) && file_exists($act . '.php')) {
    ...
    if ($id) {
        $type = $db->query("SELECT * FROM `gallery` WHERE `id` = '$id' LIMIT 1");
        $ms = $type->fetch_assoc();
        switch ($ms['type']) {
            case 'rz':
                /*
                ...
                */
                ...
                $total = $db->query("SELECT COUNT(*) FROM `gallery` WHERE `type` = 'al' AND `refid` = '$id'")->fetch_row()[0];
                ...
                if ($total) {
                    ...
                    while ($res = $req->fetch_assoc()) {
                        ...
                        $total_f = $db->query("SELECT COUNT(*) FROM `gallery` WHERE `type` = 'ft' AND `refid` = '" . $res['id'] . "'")->fetch_row()[0];
        ...
        */
        ...
        while ($res = $req->fetch_assoc()) {
            echo $i % 2 ? '<div class="list2">' : '<div class="list1">';
            $al = $db->query("SELECT * FROM `gallery` WHERE type='al' AND  refid='" . $res['id'] . "'");
            $countal = $al->num_rows;
