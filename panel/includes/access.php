...
if (isset($_POST['submit'])) {
    ...
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['reg']) ? intval($_POST['reg']) : 0) . "', `key`='mod_reg'");
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['forum']) ? intval($_POST['forum']) : 0) . "', `key`='mod_forum'");
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['guest']) ? intval($_POST['guest']) : 0) . "', `key`='mod_guest'");
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['lib']) ? intval($_POST['lib']) : 0) . "', `key`='mod_lib'");
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['gal']) ? intval($_POST['gal']) : 0) . "', `key`='mod_gal'");
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['down']) ? intval($_POST['down']) : 0) . "', `key`='mod_down'");
    $db->query("REPLACE `cms_settings` SET `val`='" . isset($_POST['libcomm']) . "', `key`='mod_lib_comm'");
    $db->query("REPLACE `cms_settings` SET `val`='" . isset($_POST['galcomm']) . "', `key`='mod_gal_comm'");
    $db->query("REPLACE `cms_settings` SET `val`='" . isset($_POST['downcomm']) . "', `key`='mod_down_comm'");
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['active']) ? intval($_POST['active']) : 0) . "', `key`='active'");
    $db->query("REPLACE `cms_settings` SET `val`='" . (isset($_POST['access']) ? intval($_POST['access']) : 0) . "', `key`='site_access'");
    $req = $db->query("SELECT * FROM `cms_settings`");
    $set = array();
    while ($res = $req->fetch_row()) $set[$res[0]] = $res[1];
