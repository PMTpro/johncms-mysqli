...
switch ($mod) {
    case 'mail':
        ...
        if (isset($_POST['submit'])) {
            ...
            $db->query("UPDATE `users` SET `set_mail` = '" . $db->real_escape_string(serialize($set_mail_user)) . "' WHERE `id` = '$user_id'");
        }
    ...
    case 'forum':
        ...
        */
        ...
        if (isset($_POST['submit'])) {
            ...
            $db->query("UPDATE `users` SET `set_forum` = '" . $db->real_escape_string(serialize($set_forum)) . "' WHERE `id` = '$user_id'");
    ...
    default:
        ...
        if (isset($_POST['submit'])) {
            ...
            */
            ...
            $db->query("UPDATE `users` SET `set_user` = '" . $db->real_escape_string(serialize($set_user)) . "' WHERE `id` = '$user_id'");
            $_SESSION['set_ok'] = 1;
            ...
            -----------------------------------------------------------------
            */
            $db->query("UPDATE `users` SET `set_user` = '' WHERE `id` = '$user_id'");
            $_SESSION['reset_ok'] = 1;
            header('Location: profile.php?act=settings');
            exit;
        }
