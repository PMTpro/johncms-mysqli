...
if ($rights == 3 || $rights >= 6) {
    ...
    if (isset($_GET['yes'])) {
        $db->query("DELETE FROM `cms_forum_vote` WHERE `topic` = '$id'");
        $db->query("DELETE FROM `cms_forum_vote_users` WHERE `topic` = '$id'");
        $db->query("UPDATE `forum` SET  `realid` = '0'  WHERE `id` = '$id'");
