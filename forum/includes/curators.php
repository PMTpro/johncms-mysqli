...
if (core::$user_rights >= 7) {
    ...
    if ($total > 0) {
        ...
        if (isset($_POST['submit'])) $db->query("UPDATE `forum` SET `curators`='" . $db->real_escape_string(serialize($curators)) . "' WHERE `id` = '$id'");
